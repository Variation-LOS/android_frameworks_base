...
public class BrightnessUtils {
    ...
    public static final boolean sysNoGammaConversion = Boolean.parseBoolean(
        SystemProperties.get("persist.sys.brightness.disable_gamma_conversion", "false"));
    ...
    public static final int convertLinearToGammaFloat(float val, float min, float max) {
        if (sysNoGammaConversion) {
            return Math.round(MathUtils.lerp(GAMMA_SPACE_MIN, GAMMA_SPACE_MAX, val));
        }
