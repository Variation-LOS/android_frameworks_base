...
public class OnGoingActionProgressController implements NotificationListener.NotificationHandler {
    ...
    public OnGoingActionProgressController(
            Context context, View statusBarView, NotificationListener notificationListener) {
    ...
    private void updateViews() {
        if (!mIsTrackingProgress) {
            ...
            // TODO: make it a bit faster by checking wether mIsTrackingProgress has change between
            // calls
