...
class RootWindowContainer extends WindowContainer<DisplayContent>
    ...
    private CharSequence mButtonBrightnessOverrideTag;
    ...
    void performSurfacePlacementNoTrace() {
        ...
        mButtonBrightnessOverrideTag = null;
        ...
        if (!mWmService.mDisplayFrozen) {
            ...
            CharSequence buttonOverrideTag = null;
            CharSequence screenOverrideTag = null;
            if (buttonBrightnessOverride != PowerManager.BRIGHTNESS_INVALID_FLOAT) {
                buttonOverrideTag = mButtonBrightnessOverrideTag;
            }
            if (screenBrightnessOverride != PowerManager.BRIGHTNESS_INVALID_FLOAT) {
                screenOverrideTag = mScreenBrightnessOverrideTag;
            }
    ...
    boolean handleNotObscuredLocked(WindowState w, boolean obscured, boolean syswin) {
        ...
        if (w.isDrawn() || (w.mActivityRecord != null && w.mActivityRecord.firstWindowDrawn
            ...
            if (!syswin && w.mAttrs.buttonBrightness >= 0
                ...
                mButtonBrightnessOverrideTag = w.getWindowTag();
            }
